...
if (isset($_POST['p_id'])) {
  $colname_showproduct = $_POST['p_id'];
}
mysql_select_db($database_connectdb, $connectdb);
...
//$query_showproduct = "SELECT * FROM tbl_product WHERE p_name	 LIKE 'Mid%' ORDER BY p_id DESC";
$showproduct = mysql_query($query_showproduct, $connectdb) or die(mysql_error());
$row_showproduct = mysql_fetch_assoc($showproduct);
$totalRows_showproduct = mysql_num_rows($showproduct);
?>
...
<div class="container">
	<div class="row">
		<div col-md-12>
<h1 align="center">ตารางสินค้ารวม</h1>
<p align="center">&nbsp;</p>
<table width="100%" border="0" align="left" cellpadding="0" id="example" class="display">
  ...
  <tr>
    ...
    <th align="center">รูปสินค้า2</th>
    <th align="center">รูปสินค้า3</th>
  ...
  <?php do { ?>
    <tr>
      ...
      <td> &nbsp;&nbsp;  &nbsp; &nbsp; <img src="img/<?php echo $row_showproduct['p_img']; ?>" width="37" height="37" /></td>
      <td align="center"><img src="img/<?php echo $row_showproduct['p_img2']; ?>" width="37" height="37" /></td>
      <td align="center"><img src="img/<?php echo $row_showproduct['p_img3']; ?>" width="37" height="37" /></td>
