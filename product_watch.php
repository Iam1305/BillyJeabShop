...
$query_showpdindex = "SELECT * FROM tbl_product WHERE p_name	 LIKE 'Big%' ORDER BY p_id DESC";
...
<?php do { ?>
  <div class="col-md-4">
  <a href="img/<?php echo $row_showpdindex['p_img']; ?>" rel="lightbox" title="กระเป๋า"><img src="img/<?php echo $row_showpdindex['p_img']; ?>" class="img-rounded img-responsive" width="380" style="padding-bottom:30px" > </a>
  <br>
  ...
  <p>
  <a href="product_detail.php?p_id=<?php echo $row_showpdindex['p_id']; ?>" class="btn btn-info"> รายละเอียด</a>
 	 <span class="btn btn-default" onclick="return confirm('กรุณาล๊อคอิน');"> สั่งซื้อ</span> 
