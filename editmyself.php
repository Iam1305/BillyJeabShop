...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "addprd")) {
  $updateSQL = sprintf("UPDATE tb_user SET u_username=%s, u_password=%s, u_name=%s, u_address=%s, u_level=%s, u_tel=%s WHERE u_id=%s",
        ...
        <div class="col-sm-12">
         ...
         <div class="form-group">
          <div class="col-sm-12">
            ...
            <a href="dataprivate.php" class="btn btn-primary">กลับหน้าหลัก</a>
          </div>
        </div>
