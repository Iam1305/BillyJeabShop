...
require_once('Connections/connectdb.php');
	foreach($_SESSION['shopping_cart'] as $p_id=>$p_qty)
	{
		...
		echo "<td width='100' align='center'><a href='cart2.php?p_id=$p_id&act=remove' class='btn btn-danger btn-xs'>ลบ</a></td>";
...
?>
        <tr>
          ...
          <a href="cart2.php?act=Cancel-Cart" class="btn btn-danger">ยกเลิกตะกร้าสินค้า</a>
          <button type="submit" name="button" id="button" class="btn btn-warning"> คำนวณราคาใหม่ </button>
            <button type="button" name="Submit2"  onclick="window.location='confirm2.php';" class="btn btn-primary"> 
            <span class="glyphicon glyphicon-shopping-cart"> </span> สั่งซื้อ </button>
            </td>
        </tr>
      </form>
      <p align="center"> <a href="frontproduct2.php" class="btn btn-primary">กลับไปเลือกสินค้า</a> </p>
    </div>
  </div>
</div>
